...
##### Steps to get started:
  ...
  - For the layout use the attributes provided by flex-layout library (fxLayout, fxFlex etc.).
    ...
    You can use the breakpoints provided by the library (xs,sm,lg, etc.) instead of the breakpoints mentioned in the designs.
